...
with open('data.txt', 'a') as f:
	f.write( add_zeros(digify(hand)) ) #digify(6, 5)
	f.write('\n')
...
while(stick_or_twist == 't'):
	...
	print('(save "t" as 1 and "s" as 0)')
	# save
	if(stick_or_twist == 't'):
		with open('labels.txt', 'a') as f:
			f.write( '1' ) #digify(6, 5)
			f.write('\n')
	else:
		with open('labels.txt', 'a') as f:
			f.write( '0' ) #digify(6, 5)
			f.write('\n')
		dont_stick_twice = False
